  ...
  if (!isUrl(websiteUrl)) {
    return (
      <div className="flex flex-col items-center justify-center gap-2">
        <div className="flex w-full p-2 justify-between items-center gap-2 overflow-auto horizontal-scroll">
          <div className="flex items-center gap-2 whitespace-nowrap w-0 text-red-600 dark:text-red-400">
